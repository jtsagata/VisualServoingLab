...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% losing 1 feature (3 real points)  %%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for t=0:dt:tf 
    ...
    traces_point = [ traces_point; p1A' p2A' p3A' ];

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %% Build the point features vector s_A in metric units ?
    s_A  = inv(K) * [p1A, p2A, p3A ;  1 1 1];
...
%    plot(traces_point(:,7), traces_point(:,8), 'k');
    plot_image3([p1B, p2B, p3B], 0);
    plot_image3([p1A, p2A, p3A], 1);
...
%       p4A_t0 = p4A;
    ...
    if t > dt
        ...
        plot_image3([p1A_t0, p2A_t0, p3A_t0], 1);
        axis ij; axis image; xlabel('i'); ylabel('j');
        axis([ 0 1024 0 1024 ]);
