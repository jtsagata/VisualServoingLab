...
for t=0:dt:tf 
    ...
    traces_point = [ traces_point; p1A' p2A'];

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %% Build the point features vector s_A in metric units ?
    s_A  = inv(K) * [p1A, p2A ;  1 1];
...
%    plot(traces_point(:,7), traces_point(:,8), 'k');
    plot_image2([p1B, p2B], 0);
    plot_image2([p1A, p2A], 1);
